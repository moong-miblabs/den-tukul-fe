        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Pernyataan</th>
                    <th class="text-start">Benar/Salah</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="(et,index) in DATA.evaluasi_pengetahuan">
                    ...
                    <td class="text-start">{{ answerToText(et.a) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Pernyataan</th>
                    <th class="text-start">SS/S/K/TP</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr v-for="(ep,index) in DATA.evaluasi_praktik">
                    ...
                    <td class="text-start">{{ answerToText(ep.a) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
...
function answerToText(a){
    if(a == '1' || a == 1) return "Benar"
    if(a == '0' || a == 0) return "Salah"
    if(a == 'SS') return "Selalu"
    if(a == 'SR') return "Sering"
    if(a == 'KD') return "Kadang"
    if(a == 'TP') return "Tidak Pernah"
    if(a == 'P1') return "Sangat Setuju"
    if(a == 'P0') return "Setuju"
    if(a == 'N0') return "Tidak Setuju"
    if(a == 'N1') return "Sangat Tidak Setuju"
    if(a == 'TT') return "Ya"
    if(a == 'FF') return "Tidak"
    return a
}
