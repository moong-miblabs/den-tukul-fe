<template>
    ...
    <div className="card">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td>11</td>
                    <td>{{ PERTANYAAN_EM[11] }}</td>
                    <td class="text-center"><input type="radio" v-model="em11" :value="'TT'"></td>
                    <td class="text-center"><input type="radio" v-model="em11" :value="'FF'"></td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>{{ PERTANYAAN_EM[12] }}</td>
                    <td class="text-center"><input type="radio" v-model="em12" :value="'TT'"></td>
                    <td class="text-center"><input type="radio" v-model="em12" :value="'FF'"></td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>{{ PERTANYAAN_EM[13] }}</td>
                    <td class="text-center"><input type="radio" v-model="em13" :value="'TT'"></td>
                    <td class="text-center"><input type="radio" v-model="em13" :value="'FF'"></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div className="card">
        <Button label="Submit" @click="onSubmit" rounded fluid></Button>
    </div>
</template>
...
function onSubmit() {
    if(!et01.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.1 belum terisi")
        return
    }
    if(!et02.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.2 belum terisi")
        return
    }
    if(!et03.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.3 belum terisi")
        return
    }
    if(!et04.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.4 belum terisi")
        return
    }
    if(!et05.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.5 belum terisi")
        return
    }
    if(!et06.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.6 belum terisi")
        return
    }
    if(!et07.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.7 belum terisi")
        return
    }
    if(!et08.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.8 belum terisi")
        return
    }
    if(!et09.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.9 belum terisi")
        return
    }
    if(!et10.value) {
        Swal.fire("Evaluasi Tingkat Pengetahuan No.10 belum terisi")
        return
    }

    if(!es01.value) {
        Swal.fire("Evaluasi Sikap No.1 belum terisi")
        return
    }
    if(!es02.value) {
        Swal.fire("Evaluasi Sikap No.2 belum terisi")
        return
    }
    if(!es03.value) {
        Swal.fire("Evaluasi Sikap No.3 belum terisi")
        return
    }
    if(!es04.value) {
        Swal.fire("Evaluasi Sikap No.4 belum terisi")
        return
    }
    if(!es05.value) {
        Swal.fire("Evaluasi Sikap No.5 belum terisi")
        return
    }
    if(!es06.value) {
        Swal.fire("Evaluasi Sikap No.6 belum terisi")
        return
    }
    if(!es07.value) {
        Swal.fire("Evaluasi Sikap No.7 belum terisi")
        return
    }
    if(!es08.value) {
        Swal.fire("Evaluasi Sikap No.8 belum terisi")
        return
    }
    if(!es09.value) {
        Swal.fire("Evaluasi Sikap No.9 belum terisi")
        return
    }
    if(!es10.value) {
        Swal.fire("Evaluasi Sikap No.10 belum terisi")
        return
    }

    if(!ep1.value) {
        Swal.fire("Evaluasi Praktik No.1 belum terisi")
        return
    }
    if(!ep2.value) {
        Swal.fire("Evaluasi Praktik No.2 belum terisi")
        return
    }
    if(!ep3.value) {
        Swal.fire("Evaluasi Praktik No.3 belum terisi")
        return
    }
    if(!ep4.value) {
        Swal.fire("Evaluasi Praktik No.4 belum terisi")
        return
    }
    if(!ep5.value) {
        Swal.fire("Evaluasi Praktik No.5 belum terisi")
        return
    }

    if(!em01.value) {
        Swal.fire("Evaluasi Motivasi No.1 belum terisi")
        return
    }
    if(!em02.value) {
        Swal.fire("Evaluasi Motivasi No.2 belum terisi")
        return
    }
    if(!em03.value) {
        Swal.fire("Evaluasi Motivasi No.3 belum terisi")
        return
    }
    if(!em04.value) {
        Swal.fire("Evaluasi Motivasi No.4 belum terisi")
        return
    }
    if(!em05.value) {
        Swal.fire("Evaluasi Motivasi No.5 belum terisi")
        return
    }
    if(!em06.value) {
        Swal.fire("Evaluasi Motivasi No.6 belum terisi")
        return
    }
    if(!em07.value) {
        Swal.fire("Evaluasi Motivasi No.7 belum terisi")
        return
    }
    if(!em08.value) {
        Swal.fire("Evaluasi Motivasi No.8 belum terisi")
        return
    }
    if(!em09.value) {
        Swal.fire("Evaluasi Motivasi No.9 belum terisi")
        return
    }
    if(!em10.value) {
    ...
    if(!ed02.value) {
        Swal.fire("Evaluasi Dukungan No.2 belum terisi")
        return
    }
    if(!ed03.value) {
        Swal.fire("Evaluasi Dukungan No.3 belum terisi")
        return
    }
    if(!ed04.value) {
        Swal.fire("Evaluasi Dukungan No.4 belum terisi")
        return
    }
    if(!ed05.value) {
        Swal.fire("Evaluasi Dukungan No.5 belum terisi")
        return
    }
    if(!ed06.value) {
        Swal.fire("Evaluasi Dukungan No.6 belum terisi")
        return
    }
    if(!ed07.value) {
        Swal.fire("Evaluasi Dukungan No.7 belum terisi")
        return
    }
    if(!ed08.value) {
        Swal.fire("Evaluasi Dukungan No.8 belum terisi")
        return
    }
    if(!ed09.value) {
        Swal.fire("Evaluasi Dukungan No.9 belum terisi")
        return
    }
    if(!ed10.value) {
...
.cardx > .cardx-header + .list-group,
.cardx > .list-group + .cardx-footer {
    border-top: 0;
}
.cardx-body {
    flex: 1 1 auto;
...
.cardx-text:last-child {
    margin-bottom: 0;
}
.cardx-link + .cardx-link {
...
.cardx-header-tabs .nav-link.active {
    background-color: var(--bs-card-bg);
...
@media (min-width: 576px) {
    ...
    .cardx-group > .cardx + .cardx {
        margin-left: 0;
        border-left: 0;
    }
    .cardx-group > .cardx:not(:last-child) {
        border-top-right-radius: 0;
        border-bottom-right-radius: 0;
    }
    .cardx-group > .cardx:not(:last-child) > .cardx-header,
    .cardx-group > .cardx:not(:last-child) > .cardx-img-top {
        border-top-right-radius: 0;
    }
    .cardx-group > .cardx:not(:last-child) > .cardx-footer,
    .cardx-group > .cardx:not(:last-child) > .cardx-img-bottom {
        border-bottom-right-radius: 0;
    }
    .cardx-group > .cardx:not(:first-child) {
        border-top-left-radius: 0;
        border-bottom-left-radius: 0;
    }
    .cardx-group > .cardx:not(:first-child) > .cardx-header,
    .cardx-group > .cardx:not(:first-child) > .cardx-img-top {
        border-top-left-radius: 0;
    }
    .cardx-group > .cardx:not(:first-child) > .cardx-footer,
    .cardx-group > .cardx:not(:first-child) > .cardx-img-bottom {
        border-bottom-left-radius: 0;
    }
}
.accordion {
